...
import com.lingxi.ai.ui.chat.ChatScreen
import com.lingxi.ai.ui.glass.GlassBottomNav
import com.lingxi.ai.ui.glass.GlassSegmented
import com.lingxi.ai.ui.ide.IdeScreen
import com.lingxi.ai.ui.settings.SettingsScreen
import com.lingxi.ai.ui.terminal.TerminalScreen

@Composable
fun LingXiScaffold(app: LingXiApp) {
    val snackbarHostState = remember { SnackbarHostState() }
    var currentTab by rememberSaveable { mutableIntStateOf(0) }
    var devTab by rememberSaveable { mutableIntStateOf(0) }

    LaunchedEffect(Unit) {
        com.lingxi.ai.MainActivity.navRequests.collect { target ->
            when (target) {
