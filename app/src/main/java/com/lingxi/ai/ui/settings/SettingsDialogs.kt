...
import com.lingxi.ai.ui.devToolCategoryLabelRes
import com.lingxi.ai.ui.devToolDescRes
import com.lingxi.ai.ui.devToolNameRes
import com.lingxi.ai.ui.themeDescRes
import com.lingxi.ai.ui.themeLabelRes
...
fun UpdateCenterDialog(onDismiss: () -> Unit) {
    ...
    LaunchedEffect(Unit) {
        loading = true
        val releases = com.lingxi.ai.update.GitHubApi.listReleases()
    ...
    result?.let { r ->
        com.lingxi.ai.ui.update.CombinedUpdateDialog(
            result = r,
...
@Composable
fun AboutLingXiDialog(onDismiss: () -> Unit) {
    AlertDialog(
        onDismissRequest = onDismiss,
        title = {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(stringResource(R.string.settings_about_lingxi), fontWeight = FontWeight.SemiBold)
            }
        },
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text(stringResource(R.string.about_version_line, BuildConfig.APP_VERSION), fontWeight = FontWeight.Medium)
...
@Composable
fun CustomModelManagerDialog(app: LingXiApp, onDismiss: () -> Unit) {
