...
import com.lingxi.ai.terminal.AndroidDependencyManager
        ...
        GlassPanel(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    Text(
                        stringResource(R.string.ide_title),
                        fontSize = 15.sp,
...
@Composable
private fun IdeDependencyDialog(app: LingXiApp, onDismiss: () -> Unit) {
    val scope = rememberCoroutineScope()
